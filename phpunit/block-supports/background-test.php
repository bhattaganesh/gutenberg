	...
	public function data_background_block_support() {
		...
		return array(
			...
			'background clip border-box style is applied' => array(
				...
				'expected_wrapper'    => '<div class="has-background" style="background-clip:border-box;-webkit-background-clip:unset;-webkit-text-fill-color:unset;">Content</div>',
				'wrapper'             => '<div>Content</div>',
			),
			...
			'background clip style is applied for block with only backgroundClip support' => array(
				...
				'expected_wrapper'    => '<p class="has-background" style="background-clip:padding-box;-webkit-background-clip:unset;-webkit-text-fill-color:unset;">Content</p>',
				'wrapper'             => '<p>Content</p>',
			),
			...
			'background clip style is appended to existing styles' => array(
				...
				'expected_wrapper'    => '<div class="wp-block-test has-background" style="color: red;background-clip:content-box;-webkit-background-clip:unset;-webkit-text-fill-color:unset;">Content</div>',
				'wrapper'             => '<div class="wp-block-test" style="color: red">Content</div>',
			),
		);
	}
